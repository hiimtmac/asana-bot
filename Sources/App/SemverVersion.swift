...
// https://github.com/vapor/release-bot/blob/main/Sources/App/Utilities/SemverVersion.swift
...
extension SemverVersion {
    enum Error: Swift.Error, LocalizedError {
        case semverParse
        case unknownSemverStrategy

        public var errorDescription: String? {
            switch self {
            case .unknownSemverStrategy:
                return "Unknown semver strategy"
            case .semverParse:
